...
public class Tab4 extends javax.swing.JPanel {
    ...
    public Tab4() {
        initComponents();
        String cbItems[] = {"bool","float","int","long","str"};
    ...
    private void bActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActionPerformed
		...
		t.setText("N / A");
	else if ((cb1.getSelectedItem() == "long") & (cb2.getSelectedItem() == "str"))
		t.setText("vIn = -9223372036854775808L;\nvOut = str(vIn);");
	
	else if ((cb1.getSelectedItem() == "str") & (cb2.getSelectedItem() == "bool"))
		t.setText("vIn = \"1\"\nvOut = bool(vIn);");
	else if ((cb1.getSelectedItem() == "str") & (cb2.getSelectedItem() == "float"))
		t.setText("vIn = \"-1.7976931348623157E308\"\nvOut = float(vIn);");
	else if ((cb1.getSelectedItem() == "str") & (cb2.getSelectedItem() == "int"))
		t.setText("vIn = \"-2147483648\"\nvOut = int(vIn,10);");
	else if ((cb1.getSelectedItem() == "str") & (cb2.getSelectedItem() == "long"))
		t.setText("vIn = \"-9223372036854775808L\"\nvOut = long(vIn,10);");
	else if ((cb1.getSelectedItem() == "str") & (cb2.getSelectedItem() == "str"))
		t.setText("N / A");
